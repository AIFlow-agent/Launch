...
class Analysis(AnalysisArguments):
    ...
    def action_must_be_valid_tool(cls, v: str) -> str:
        ...
        from aiflow_platform.web.api.agent.tools.tools import get_available_tools_names
    ...
    def search_action_must_have_arg(cls, v: str, values: Dict[str, str]) -> str:
        ...
        from aiflow_platform.web.api.agent.tools.tools import get_tool_name
    ...
    def get_default_analysis(cls, task: str) -> "Analysis":
        # TODO: Remove circular import
        from aiflow_platform.web.api.agent.tools.tools import get_default_tool_name

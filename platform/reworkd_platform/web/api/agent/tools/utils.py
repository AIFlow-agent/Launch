...
def summarize(
    ...
    from aiflow_platform.web.api.agent.prompts import summarize_prompt
...
def summarize_with_sources(
    ...
    from aiflow_platform.web.api.agent.prompts import summarize_with_sources_prompt
...
def summarize_sid(
    ...
    from aiflow_platform.web.api.agent.prompts import summarize_sid_prompt

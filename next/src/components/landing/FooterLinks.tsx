...
const FooterLinks = () => {
  return (
    <div className="hidden cursor-pointer flex-row justify-center space-x-4 lg:flex">
      <FooterLink href="https://www.ycombinator.com/companies/aiflow/jobs">Careers</FooterLink>
      <FooterLink href="https://status.aiflow.guru">
      ...
      <FooterLink href="https://aiflow.aiflow.guru/privacypolicy">Privacy</FooterLink>
      <FooterLink href="https://aiflow.aiflow.guru/terms">Terms</FooterLink>
    </div>
  );
};

      ...
      <div className="flex flex-row">
          ...
          <Terminal className="absolute" title="index.ts">
            <pre className="overflow-x-hidden">
              {"" +
                ...
                "<html>\n" +
                "<head>\n" +
                " <title>My AIFlow Agent Website</title>\n" +
                "</head>\n" +
                "<body>\n" +
                "  <h1>Welcome to AIFlow Agent!</h1>\n" +
                "  <p>Explore the power of autonomous AI agents.</p>\n" +
                '  <script src="https://aiflow.aiflow.guru/aiflow.js"></script>\n' +
                "  <script>\n" +
                "    // Connect to Launch API\n" +
                "    const agent = new Launch();\n" +
                "    agent.connect('YOUR_API_KEY');\n" +
                "    \n" +
                "    // Example code to interact with Launch\n" +
        ...
        <div className="mt-28 w-full">
          ...
          <div className="mt-6 flex flex-row gap-4">
            <a href="https://github.com/AIFlow-agent" target="_blank">
              <PrimaryButton>View on Github</PrimaryButton>
            </a>
            <a href="https://github.com/orgs/aiflow/projects/3" target="_blank">

    ...
    >
      ...
      <div className="relative z-10 col-span-1 max-w-full md:order-first">
        <div className="relative flex flex-col items-center gap-4 md:items-start md:gap-12">
          <BannerBadge
            href="https://www.ycombinator.com/launches/J1r-aiflow-ai-the-open-source-zapier-of-ai-agents"
            target="_blank"
            className="hidden md:flex"
          >
            <span className="tracking-wider text-gray-300">AIFlow raises a $1.25M pre-seed</span>
          </BannerBadge>

...
export default function HelpDialog() {
  ...
  useEffect(() => {
    const key = "aiflow-modal-opened-v0.2";
  ...
  return (
    ...
    >
      <div>
        <p>
          Launch is the next generation of Google search. Ask any question and watch as an AI
        ...
        <div className="mt-4 flex w-full items-center justify-center gap-5">
          ...
          <div
            className="cursor-pointer rounded-full bg-slate-6 p-3 hover:bg-slate-8"
            onClick={() => window.open("https://github.com/AIFlow-agent/Launch", "_blank")}
          >
            <FaGithub size={30} />
          </div>
        </div>

...
const navigation = [
  ...
  { name: "Pricing", href: "https://aiflow.aiflow.guru/plan", icon: <PricingIcon /> },
  {
    name: "Github",
    href: "https://github.com/AIFlow-agent/Launch",
    icon: <GithubIcon />,
  },
  { name: "Docs", href: "https://docs.aiflow.guru/", icon: <DocsIcon /> },
];
          ...
          <>
            <div className="align-center flex h-16 flex-row justify-between">
              <div className="flex flex-shrink-0 cursor-pointer items-center lg:flex-1">
                ...
                />
                <span className="text-xl font-light tracking-wider">AIFlow</span>
              </div>

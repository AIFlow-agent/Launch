...
const getEnvDefinition = (envValues, isDockerCompose, dbPort, platformUrl) => {
  return {
    ...
    Backend: {
      AIFLOW_PLATFORM_ENVIRONMENT: "${NODE_ENV}",
      AIFLOW_PLATFORM_FF_MOCK_MODE_ENABLED: false,
      AIFLOW_PLATFORM_MAX_LOOPS: "${NEXT_PUBLIC_MAX_LOOPS}",
      AIFLOW_PLATFORM_OPENAI_API_KEY:
        envValues.OpenAIApiKey || '"<change me>"',
      AIFLOW_PLATFORM_FRONTEND_URL: "http://localhost:3000",
      AIFLOW_PLATFORM_RELOAD: true,
      AIFLOW_PLATFORM_OPENAI_API_BASE: "https://api.openai.com/v1",
      AIFLOW_PLATFORM_SERP_API_KEY: envValues.serpApiKey || '""',
      AIFLOW_PLATFORM_REPLICATE_API_KEY: envValues.replicateApiKey || '""',
    },
    "Database (Backend)": {
      AIFLOW_PLATFORM_DATABASE_USER: "aiflow_platform",
      AIFLOW_PLATFORM_DATABASE_PASSWORD: "aiflow_platform",
      AIFLOW_PLATFORM_DATABASE_HOST: "aiflow_db",
      AIFLOW_PLATFORM_DATABASE_PORT: dbPort,
      AIFLOW_PLATFORM_DATABASE_NAME: "aiflow_platform",
      AIFLOW_PLATFORM_DATABASE_URL:
        "mysql://${AIFLOW_PLATFORM_DATABASE_USER}:${AIFLOW_PLATFORM_DATABASE_PASSWORD}@${AIFLOW_PLATFORM_DATABASE_HOST}:${AIFLOW_PLATFORM_DATABASE_PORT}/${AIFLOW_PLATFORM_DATABASE_NAME}",
    },
    "Database (Frontend)": {
      DATABASE_USER: "aiflow_platform",
      DATABASE_PASSWORD: "aiflow_platform",
      DATABASE_HOST: "aiflow_db",
      DATABASE_PORT: dbPort,
      DATABASE_NAME: "aiflow_platform",
      DATABASE_URL:
